/**
 * Client-bundle build for the browser half, following the harness preset
 * (packages/client/tsdown.client.ts): a closure-factory CJS artifact that
 * hands itself to window.__ModuleLoader__ and resolves externals through
 * the frozen module table (platform modules only). CSS Modules are compiled
 * by lightningcss into injected <style data-plugin> tags.
 */
...
export default defineConfig({
  ...
  // Only the module table may stay external; everything else inlines.
